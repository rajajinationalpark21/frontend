...
import { Trees, Compass, CheckCircle2, ArrowRight } from 'lucide-react';
import { floraData } from '../data/parkContent';
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors">
      ...
      <section className="relative py-20 bg-safari-900 text-white overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-25">
          <img
            src={safariImages.mistyDarkPines}
            alt="Dense Sal forest canopy"
      ...
      {/* Altitudinal Bands */}
      <section className="py-12 bg-safari-800/20 dark:bg-safari-900/30 border-b border-safari-500/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">
            Altitudinal Vegetation Bands
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {floraData.altitudinalBands.map((band, idx) => (
              <div key={idx} className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
                <span className="font-extrabold text-safari-600 dark:text-safari-400 text-sm block mb-1">
                  {band.band}
                </span>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                {floraData.dominantTrees.map((tree, idx) => (
        ...
        <div className="bg-emerald-50/50 dark:bg-emerald-950/20 p-8 rounded-3xl border border-emerald-100 dark:border-emerald-900/30 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-2">
            <h3 className="text-xl font-bold text-gray-900 dark:text-white">
              Experience the Pristine Sal Canopy
            </h3>
