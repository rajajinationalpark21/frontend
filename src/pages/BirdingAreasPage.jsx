...
import { MapPin, Compass, Clock, Navigation, CheckCircle2, ShieldCheck, ArrowRight } from 'lucide-react';
import { birdingAreasData } from '../data/parkContent';
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-white mb-6">
              Major Birding Areas & Trails
            </h1>
            <p className="text-lg text-gray-300 leading-relaxed">
              Explore the four primary birding transects across Rajaji National Park, traversing riparian wetlands, deciduous forests, and serene Shivalik foothills.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {birdingAreasData.map((trail, idx) => (
            <div
              key={idx}
              className="bg-white dark:bg-gray-900 rounded-3xl p-8 border border-gray-200 dark:border-gray-800 shadow-sm flex flex-col justify-between hover:border-safari-500/40 transition"
            >
              <div className="space-y-4">
                <div className="flex items-center justify-between gap-2">
                  <span className="px-3 py-1 rounded-full bg-safari-500/10 text-safari-600 dark:text-safari-400 text-xs font-bold uppercase tracking-wider">
                    {trail.badge}
                  </span>
              ...
              <div className="mt-8 pt-6 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between text-xs">
                <div>
                  <span className="text-gray-400 block">Operating Season:</span>
                  <span className="font-semibold text-gray-800 dark:text-gray-200">{trail.season}</span>
                </div>
                <div className="text-right">
                  <span className="text-gray-400 block">Trail Tariff:</span>
                  <span className="font-bold text-safari-600 dark:text-safari-400">{trail.fee}</span>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="bg-gray-50 dark:bg-gray-900 p-8 rounded-3xl border border-gray-200 dark:border-gray-800">
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
            <Navigation className="w-5 h-5 text-safari-600" />
