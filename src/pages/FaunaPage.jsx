...
import { Eye, ShieldCheck, Heart, Sparkles, Check, ArrowRight } from 'lucide-react';
import { faunaData } from '../data/parkContent';
      ...
      <section className="relative py-20 bg-safari-900 text-white overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-25">
          <img
            ...
            alt="Royal Bengal Tiger in Rajaji"
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {faunaData.primeAttractions.map((animal, idx) => (
              <div
                key={idx}
              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <span className="px-3 py-1 rounded-full bg-safari-500/10 text-safari-600 dark:text-safari-400 text-xs font-bold uppercase">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-gray-50/60 dark:bg-gray-900/40 p-8 rounded-3xl border border-gray-200 dark:border-gray-800">
            ...
            <div className="space-y-4">
              {faunaData.herbivores.map((h, hIdx) => (
          ...
          <div className="bg-gray-50/60 dark:bg-gray-900/40 p-8 rounded-3xl border border-gray-200 dark:border-gray-800">
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">
              Carnivores & Forest Hunters
            </h3>
            <div className="space-y-4">
              {faunaData.carnivores.map((c, cIdx) => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white dark:bg-gray-900 p-8 rounded-3xl border border-gray-200 dark:border-gray-800 shadow-sm">
            ...
            <div className="space-y-3">
              {faunaData.reptiles.map((rep, rIdx) => (
          ...
          <div className="bg-white dark:bg-gray-900 p-8 rounded-3xl border border-gray-200 dark:border-gray-800 shadow-sm flex flex-col justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-6 leading-relaxed">
                The Holy River Ganges bisects Rajaji for 24 km alongside the Song River, creating thriving riverine ecosystems for rare mahseer and otters.
              </p>

              <div className="flex flex-wrap gap-2">
                {faunaData.aquaticLife.fishes.map((fish, fIdx) => (
                  <span key={fIdx} className="px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-950/40 text-blue-700 dark:text-blue-300 text-xs font-semibold">
                    {fish}
                  </span>
                ))}
              </div>
